...
<xsl:stylesheet version="2.0"
	...
	<xsl:template match="/|/|/" name="service-dto-fill-children.xsl">
	...
	<xsl:param name="methodName"/>package <xsl:value-of select="$rootPackage"/>;
		...
		<xsl:variable name="getMethodNode" select="$methodNode/annotations/annotation[@name='clear.cdb.js.annotations.CX_JSFillChildrenMethod']"/>
