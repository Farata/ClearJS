...
<xsl:stylesheet version="2.0"
	...
	<xsl:template match="/|/|/" name="generate-model-jpql.xsl">
		...
		<xsl:variable name="jpqlMethodNode"
			select="$methodNode/annotations/annotation[@name='clear.cdb.annotations.CX_JPQLMethod']" />
		<xsl:variable name="types"
			select="$jpqlMethodNode/method[@name='query']/query" />
		<xsl:variable name="updateInfo"
			select="$methodNode/annotations/annotation[@name='clear.cdb.annotations.CX_UpdateInfo'] | $jpqlMethodNode/method[@name='updateInfo']/value/annotation" />
