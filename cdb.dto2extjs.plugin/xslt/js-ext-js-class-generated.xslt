...
>
	<xsl:template match="/dto2extjs:class" mode="generated-file">
		...
		<xsl:variable name="relationPropertiesM1" select="dto2extjs:property[not(@abstract = 'true') and (dto2extjs:ManyToOne)]"/>/* Generated by DTO2EXTJS from <xsl:value-of select="$thisClass"/>.java on <xsl:value-of select="date:date-time()"/>*/
