...
public class _CompanyService implements com.farata.java_test.service.ICompanyService {
		
	public java.util.List<com.farata.java_test.dto.CompanyDTO> fill() {
		return null;
	}
 	...
 	public List<ChangeObject> fill_sync(List<ChangeObject> items) throws Exception {
		...
		MessagingUtils.pushChanges("com.farata.java_test.ICompany.fill", items);
	...
	public List<ChangeObject> fill_insertItems(List<ChangeObject> items) throws Exception {
		...
		MessagingUtils.pushChanges("com.farata.java_test.ICompany.fill", list);
